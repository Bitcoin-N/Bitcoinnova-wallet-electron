...
const SERVICE_FILENAME =  (platform === 'win32' ? 'Bitcoinnova-service.exe' : 'Bitcoinnova-service' );
const DEFAULT_SERVICE_BIN = path.join(process.resourcesPath, SERVICE_FILENAME);
const DEFAULT_TITLE = 'Bitcoin nova Wallet';
const DEFAULT_TRAY_TIP = 'Slow and steady wins the race!';
const PUBLIC_NODES_URL = 'https://raw.githubusercontent.com/Bitcoin-N/Bitcoinnova-nodes-json/master/Bitcoinnova-nodes.json';
...
const DEFAULT_SETTINGS = {
    ...
    daemon_host: 'pool.bitcoinnova.org',
    daemon_port: 45223,
    pubnodes_date: null,
    pubnodes_data: FALLBACK_NODES,
    pubnodes_custom: ['127.0.0.1:45223'],
    tray_minimize: false,
    tray_close: false
}
